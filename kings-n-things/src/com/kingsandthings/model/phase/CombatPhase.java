...
public class CombatPhase extends Phase {
	...
	public void initiateCombat(Player playerDefender, Player playerAttacker,
		...
		// TODO don't leave this in endless loop!
		while (!retreat) {
			...
			// TODO players must choose if they wish to retreat, in order, starting with attackers
			/*
			 * if ((playerAttacker.isRetreat()) || playerDefender.isRetreat()) 
			 * 	retreat = true; 
			 * else if (defenders.isEmpty() || attackers.isEmpty())
			 * 	retreat = true;
			 */
		}
	...
	private void playerRemoveCreatures(Player player, List<Creature> creatures, int damage) {
		// TODO player removes number of creatures of their choice = damage
